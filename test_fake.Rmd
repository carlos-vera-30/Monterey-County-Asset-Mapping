...
function initializeInterface() {
    ...
    try {
        ...
        if (window.assetMap && !window.markersLayer) {
            window.markersLayer = L.layerGroup().addTo(window.assetMap);
        }
...
function updateMapMarkers() {
    ...
    // Create a layer group to manage markers if it doesn't exist
    if (!window.markersLayer) {
        window.markersLayer = L.layerGroup().addTo(window.assetMap);
    } else {
        window.markersLayer.clearLayers(); // Clear existing markers
    }
