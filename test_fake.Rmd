...
function initializeDataTableReference() {
  ...
  const checkForDataTable = () => {
    attempts++;
    console.log(`Attempt ${attempts}: Checking for DataTable...`);
    ...
    if ($.fn.DataTable.isDataTable('#assetsDataTable')) {
      ...
      console.log('DataTable reference established:', assetsDataTable);
      
      // Add event listener for when DataTable is fully drawn
      assetsDataTable.on('draw.dt', function() {
...
function waitForDataTable() {
  // Check if DataTable is ready, if not, wait and try again
  if ($.fn.DataTable.isDataTable('#assetsDataTable')) {
    updateResultsTable();
  } else {
...
// Also add a variable to track when selectedCategories is defined
