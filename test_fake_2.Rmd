...
if (!is.null(asset_data)) {
  ...
  Monterey_County_Assets <- cleaned_data %>%
    ...
    filter(!is.na(Latitude) & !is.na(Longitude))  # Only keep successfully geocoded entries
...
# ADD THIS SECTION HERE - Data transfer to JavaScript
# Create JavaScript variables that will be accessible globally
...
# Print the script (this will embed it in the HTML)
cat(js_data_script)
